...
Requires:  postgresql14-libs, postgresql14-server, postgresql14-llvmjit, centos-release-scl, epel-release
...
mkdir -p %{buildroot}/usr/pgsql-14/lib/bitcode/pg_store_plans
mkdir -p %{buildroot}/usr/pgsql-14/share/extension/
cp -r %{_topdir}/../../*.bc %{buildroot}/usr/pgsql-14/lib/bitcode/pg_store_plans
cp -r %{_topdir}/../../pg_store_plans.so %{buildroot}/usr/pgsql-14/lib/
cp -r %{_topdir}/../../pg_store_plans.control %{buildroot}/usr/pgsql-14/share/extension/
cp -r %{_topdir}/../../pg_store_plans*.sql %{buildroot}/usr/pgsql-14/share/extension/

%post
cd '/usr/pgsql-14/lib/bitcode' && /usr/lib64/llvm5.0/bin/llvm-lto -thinlto -thinlto-action=thinlink -o pg_store_plans.index.bc pg_store_plans/pg_store_plans.bc pg_store_plans/pgsp_json.bc pg_store_plans/pgsp_json_text.bc pg_store_plans/pgsp_explain.bc
