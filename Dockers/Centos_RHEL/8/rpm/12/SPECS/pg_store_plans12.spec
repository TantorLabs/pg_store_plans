...
Requires:  postgresql12-libs, postgresql12-server, postgresql12-llvmjit
...
%post
cd '/usr/pgsql-12/lib/bitcode' && /usr/bin/llvm-lto -thinlto -thinlto-action=thinlink -o pg_store_plans.index.bc pg_store_plans/pg_store_plans.bc pg_store_plans/pgsp_json.bc pg_store_plans/pgsp_json_text.bc pg_store_plans/pgsp_explain.bc
